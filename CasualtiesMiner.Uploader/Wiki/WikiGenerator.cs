...
public static class WikiGenerator
{
    ...
    public static string BuildDataModule(IReadOnlyList<ItemRow> rows)
    {
        ...
        foreach (var row in rows)
        {
            ...
            foreach (var (key, value) in EnumerateFields(row))
            {
    ...
    private static IEnumerable<(string Key, string Value)> EnumerateFields(ItemRow row)
    {
